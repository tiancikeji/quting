  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved guest as @guest" do
        ...
        post :create, {:guest => { "device_token" => "invalid value" }}, valid_session
        assigns(:guest).should be_a_new(Guest)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested guest" do
        ...
        Guest.any_instance.should_receive(:update_attributes).with({ "device_token" => "MyString" })
        put :update, {:id => guest.to_param, :guest => { "device_token" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the guest as @guest" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Guest.any_instance.stub(:save).and_return(false)
        put :update, {:id => guest.to_param, :guest => { "device_token" => "invalid value" }}, valid_session
        assigns(:guest).should eq(guest)
      end
